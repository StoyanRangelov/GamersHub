...
namespace GamersHub.Services.Data.PartyApplicants
{
    ...
    {
        /// <summary>
        /// Approves a party application to the party by the given party id and applicant id, returns 0 if the party application does not exist, otherwise returns the party id
        /// </summary>
        ...
        /// <summary>
        /// Declines a party application from a party by the given party id and applicant id, returns 0 if the party application does not exist, otherwise returns the party id
        /// </summary>
        /// <param name="partyId"></param>
        /// <param name="applicantId"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Removes a party application from a party by the given party id and applicant id, returns 0 if the party does not exist, otherwise returns the party id
        /// </summary>
        /// <param name="partyId"></param>
        /// <param name="applicantId"></param>
        /// <returns></returns>
