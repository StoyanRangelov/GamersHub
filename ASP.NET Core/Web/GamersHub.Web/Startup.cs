                ...
                endpoints =>
                    {
                        ...
                        endpoints.MapControllerRoute("forum", "Forums/{name:minlength(4)}/{id?}", new {controller = "Forums", action = "ByName"});
                        endpoints.MapControllerRoute("post", "Posts/{name:minglength(4)/{id?}", new {controller = "Posts", action = "ByName"});
